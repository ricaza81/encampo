...
{
   $serviceAccount = ServiceAccount::fromJsonFile(__DIR__.'/app2-936b7-firebase-adminsdk-e09ll-2067d6964b.json');
...
function reportfincasaguacate()
    { 
          ...
          $areas_totales_sembradas=DB::table('dane_censo')->where('id_depto','=',$departamento)->where('id_cultivo','=',$cultivo->id_cultivo)->sum('area_sembrada');
