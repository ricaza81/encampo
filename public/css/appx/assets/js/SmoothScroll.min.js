! function() {
  ...
  function a(e) {
    ...
    if (r.test(t.nodeName) || h(t, "input") && !a.test(t.type) || h(D, "video") || y(e) || t.isContentEditable || e.defaultPrevented || o) return !0;
  ...
  function v(e) {
    return e ? (N.length || (N = [e, e, e]), e = Math.abs(e), N.push(e), N.shift(), clearTimeout(H), H = setTimeout(function() {
  ...
  var I, _ = function() {
    ...
    ee = (G || J || Z) && !Q;
  "onwheel" in document.createElement("div") ? I = "wheel" : "onmousewheel" in document.createElement("div") && (I = "mousewheel"), I && ee && (m(I, r), m("mousedown", i), m("load", t)), k.destroy = o, window.SmoothScrollOptions && k(window.SmoothScrollOptions), "function" == typeof define && define.amd ? define(function() {
    return k
