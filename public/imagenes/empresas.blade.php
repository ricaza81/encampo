           ...
           <div id="accordion" role="tablist" aria-multiselectable="true" class="accordion-faqs" style="padding:30px">
              ...
              <div class="card-header" role="tab" id="headingOne">
                <h3 class="mb-0">
                  <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                   Integramos toda la información desde tu CRM
            ...
            <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne">
              <p style="color:#000000">
               Analizamos su CRM haciendo especial énfasis en la estructura de datos para integrar toda la información y obtener nuevos hallazgos del mercado:

                <div class="img-one">
                <img class="" src="{{asset('imagenes/query1.png')}}" alt="Prosess" />
                </div>

               <li>1. Implementamos técnicas de análisis de datos,</li>
               <li>2. Construimos un Tablero de Control para su Empresa,</li>
               <li>3. Contamos con nuestra API para desarrolladores e integración.</li>
              </p>
