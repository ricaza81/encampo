...
function cambiar_fecha_grafica(){
    ...
    cargar_grafica_lineas_seguimientos (anio_sel,mes_sel);
...
var options={
	 ...
	 chart: {
        ...
        title: {
            ...
            text: 'Numero de Agricultores creados en el mes'

        },

        subtitle: {

            text: 'Fuente: Agronielsen en Campo'
...
function cargar_grafica_lineas_seguimientos(anio,mes){
...
var options={
     ...
     chart: {
            ...
            renderTo: 'div_grafica_lineas_seguimientos',
        ...
        title: {
            ...
            text: 'Numero de Seguimientos por día'
        ...
        yAxis: {
            ...
            title: {
                ...
                text: 'SEGUIMIENTOS DE PROYECTOS POR DIA'
...
$("#div_grafica_lineas_seguimientos").html( $("#cargador_empresa").html() );



var url = "grafica_seguimientos/"+anio+"/"+mes+"";
