...
//funcion para atrapar los formularios y enviar los datos
      ...
      //  if(quien=="f_nueva_visitatecnica_agricultor"){ var varurl="agregar_nueva_visitatecnica_agricultor"; var divresul="notificacion_resul_fanu"; }
        if(quien=="form1_nuevo_producto_visitatecnica_agricultor"){ var varurl="https://www.agronielsen.com/encampo/public/agregar_nuevo_producto_visitatecnica_agricultor"; var divresul="notificacion_resul_fanu"; }
...
function mostrarficha(id_usuario,tipo) {
  ...
  if(tipo==1){var url = "form_editar_usuario/"+id_usuario+""; }else{ var url = "form_editar_usuario/"+id_usuario+""; }
