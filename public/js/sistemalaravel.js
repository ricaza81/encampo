...
//funcion para atrapar los formularios y enviar los datos
       ...
       e.preventDefault();
        ...
        if(quien=="form1_nuevo_fincas_arboles"){ var varurl="https://www.agronielsen.com/encampo/public/form_editar_finca_aguacate/agregar_nuevo_arboles_finca_aguacate"; var divresul="notificacion_resul_fanu"; rs=true;}
        if(quien=="form1_nuevo_fincas_clientes"){ var varurl="https://www.agronielsen.com/encampo/public/form_editar_finca_aguacate/agregar_nuevo_cliente_finca_aguacate"; var divresul="notificacion_resul_fanu_cliente"; rs=true;}
        if(quien=="form1_nuevo_fincas_contactos"){ var varurl="https://www.agronielsen.com/encampo/public/form_editar_finca_aguacate/agregar_nuevo_contacto_finca_aguacate"; var divresul="notificacion_resul_fanu_contacto"; rs=true;}
        ...
        if(quien=="form1_visita_nueva_semana_pdn"){ var varurl="https://www.agronielsen.com/encampo/public/form_editar_visita_finca_aguacate/agregar_visita_nueva_semana_pdn"; var divresul="notificacion_resul_fanu_semanapdn"; rs=true;}
        if(quien=="form1_visita_nueva_semana_cosecha"){ var varurl="https://www.agronielsen.com/encampo/public/form_editar_visita_finca_aguacate/agregar_visita_nueva_semana_cosecha"; var divresul="notificacion_resul_fanu_semanacosecha"; rs=true;}
        if(quien=="form1_visita_nuevo_pdn_arboles"){ var varurl="https://www.agronielsen.com/encampo/public/form_editar_visita_finca_aguacate/agregar_visita_nuevo_pdn_arboles"; var divresul="notificacion_resul_fanu_pdn_arboles"; rs=true;}
...
function mostrarfincagcte(id_usuario) {
  //funcion para mostrar y etditar la informacion del usuario
 
  $("#usuario_seleccionado").val(id_usuario); // leccion10
  $("#capa_modal").show();
  $("#capa_para_edicion").show();
  {var url = "form_editar_finca_aguacate_js/"+id_usuario+""; }
  //if(tipo==1){var url = "form_editar_prospecto/"+id_usuario+""; }else{ var url = "info_datos_usuario/"+id_usuario+""; }
  $("#contenido_capa_edicion").html($("#cargador_empresa").html());  //leccion 10
  $.get(url,function(resul){
  $("#contenido_capa_edicion").html(resul);  //leccion 10
