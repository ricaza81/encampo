  ...
  <div id="site-banner1" style="padding-top:40px">
        ...
        <div class="row">
          <div class="col-md-7">
            <div class="banner-content">
              ...
              <h2 class="title wow fadeInUp" data-wow-delay="0.3s">Asistencia Técnica para Agricultores</h2>

              <p class="sub-title wow fadeInUp" data-wow-delay="0.5s">
                Recibe la asesoría directamente de los equipos técnicos de las Empresas Comerciales que hacen parte de nuestra comunidad.
              </p>

              <a href="https://www.agronielsen.com/encampo/public/rankingasesores" class="banner-btn wow fadeInUp" data-wow-delay="0.7s">Solicitar Asistencia</a>
            </div>
            <!-- /.banner-content -->
          </div>
          <!-- /.col-md-6 -->
          ...
          <!--  <div class="banner-mobile">-->
              <div class="feature-image">
               <!-- <img src="https://www.agronielsen.com/encampo/public/css/appx/media/faq/productor-agri.png" class="wow fadeInUp" alt="Mobile">-->
                   <a href="https://www.agronielsen.com/encampo/public/rankingasesores"><img  src="https://www.agronielsen.com/encampo/public/css/appx/media/faq/restaurantes.png" class="wow fadeInUp" alt="Mobile"></a>
           <!--   </div> -->
   ...
   background: linear-gradient(to right,#ff9432,#79a42e);
    ...
    <a href="rankingasesores" style="color:#fff"><b>Asesores Técnicos</b></a></span>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-5" style="padding-top:50px" id="asistencia">
                    <h3 class="title wow fadeInUp">Una comunidad técnica dispuesta a asesorarte,
                    </h3>
                    <h2 class="title wow fadeInUp" data-wow-delay="0.3s">Para aumentar tu productividad.
                    </h2>
                    <p class="sub-title wow fadeInUp" data-wow-delay="0.5s">
                      Encontrarás recomendaciones técnicas de Profesionales del Agro, expertos en control fitosanitario, fertilización, nutrición balanceada de cultivos y manejo integral. Compartenos una fotografía de tu cultivo para una mejor asesoría técnica.
                    </p>
                       <div class="form-group">
                               <div class="banner-mobile">
              <div class="img-responsive">
                <img src="https://www.agronielsen.com/encampo/public/css/appx/media/faq/agrismarth.png" class="wow fadeInUp" alt="Mobile">
...
.img-responsive:hover {
    transform: scale(1.2); /* (150% zoom - Note: if the zoom is too large, it will go outside of the viewport) */
                      ...
                      <form action="{{ url('/newasesoria') }}" method="post" class="form-horizontal form-material" enctype="multipart/form-data">
                                                <div class="form-group">
                                       <!--   <img src="https://www.agronielsen.com/encampo/public/imagenes/avatar.jpg"  alt=""  style="width:60px;height:60px;" id="" >-->
                                                <label for="foto"><b>Foto del cultivo:</b></label>
         ...
         <!--    <div class="banner-mobile">    -->        
              <div class="login-box card">
                <div class="card-body" style="margin-top:10px">
                        ...
                        <h3 class="box-title text-center" style="padding: 10px 0 10px 0;background: #00A859;/*margin-bottom: 28px;*/color:#fff;border-radius: 4.25rem;font-size:18px;font-weight:450;font-family:"Montserrat", sans-serif;">Solicitar Asistencia!
                        </h3>
                ...
                <?php  for($i=0;$i<=count($cultivos)-1;$i++){  if($cultivos[$i]->id !=$i){ ?>
                      ...
                      <?php   }} ?>
                          ...
                          <div class="form-group">      
                            ...
                            <input type="text" class="form-control" name="hectareas" >
                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                          </div>
                         </div>
                        <div class="col-md-8">
                      <div class="form-group" style="margin-left:10px">
                                            <label>Mensaje</label>
                                            <textarea class="form-control" rows="3" id="objetivo" name="observaciones" placeholder="En que requieres asesoría?"></textarea>
                    </div>
                </div>                
                      <div class="col-md-12" >
                          <div class="form-group" style="padding-top:20px">  
                
                        <button type="submit" class="btn btn-primary">SOLICITAR ASISTENCIA</button>
           </div>
                </div>  
