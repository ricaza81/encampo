    ...
    <div class="row full-width" style="padding-top: 39px;">
      <div class="col col-xl-12 m-auto col-lg-12 col-md-12 col-sm-12 col-12" style="margin-right: -16px;">
        <div class="site-logo" style="margin-top: -25px;margin-right: -16px;">
         ...
         <div class="col col-xl-5 m-auto col-lg-5 col-md-5 col-sm-5 col-5" style="margin-right: -16px;float: left">
                        <h2 class="presentation-margin text-left" style="letter-spacing:-2px;margin-top:-336px;padding:20px;margin-bottom:-16px;color:#fff;border-bottom: 1px solid #fff">Comprar nuevo historial personalizado
                        </h2>


                         <a style="font-size:25px;margin-top:0px;width:272px;padding-left:27px;float: right;background: #76A82B;margin-top: -60px;" class="btn btn-purple btn-lg" href="https://agronielsen.com/encampo/public/descargables/ConsultaFincaRisaraldaSept2020.pdf" target="_blank">Esto obtienes
                                                    </a>

                        <h2 class="presentation-margin text-right" style="letter-spacing:-2px;margin-top:20px;padding:20px;margin-bottom:-16px;color:#fff">Ingresa las coordenadas: (latitud y longitud)
                        </h2>
              <p class="responsive-display-none" style="font-size:16px;letter-spacing:1px;line-height:18px;color:#fff;">
                          ...
                          <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                            <div class="row">
                                <div class="col col-lg-3 col-md-3 col-sm-12 col-12">
                                  <h3 style="margin-top: 8px;margin-bottom: -31px;float:right">Latitud:</h3><br>
                                  <label style="margin-top: 0px;float:right;font-size: 14px;padding:15px">(Ej: 3.46)</label>
                                </div>
                                ...
                                <div class="col col-lg-3 col-md-3 col-sm-12 col-12">
                                  <h3 style="margin-top: 8px;margin-bottom: -31px;float:right">Longitud:</h3><br>
                                  <label style="margin-top: 0px;float:right;font-size: 14px;padding:15px">(Ej: -75.53)</label>
                                </div>
                                <div class="col col-lg-9 col-md-9 col-sm-12 col-12">
                                <div class="form-group label-floating is-empty">
                                  <label class="control-label"></label>
                                    ...
                                    <input class="form-control" style="font-size:8px" type="hidden" placeholder="" id="url" name="url">
                                         ...
                                         <div class="checkbox checkbox-primary p-t-0">
                                               <input id="checkbox-signup" type="checkbox" name="remember"/>
                                                <label for="checkbox-signup" style="margin-left: 20px;"> Consultar mi ubicación actual
                                                </label>


                                             
                                                    <a style="font-size:25px;margin-top:0px;width:272px;padding-left:27px;float: right;background: #76A82B" class="btn btn-purple btn-lg" href="https://checkout.wompi.co/l/72SHUi" target="_blank">Comprar
                                                    </a>
        ...
        <div class="col col-xl-6 m-auto col-lg-6 col-md-6 col-sm-6 col-6">
              <div id="map_canvas" class="map_canvas" style="height: 850px;margin-right: 0px;overflow: hidden;position: initial;width: 64%;">
              </div>         
       
               
                        <p class="responsive-display-none" style="font-size:12px;letter-spacing:-1px;line-height:18px;color:#000;">
                             Ingresando las variables de Latitud y Longitud de una ubicación, obtendrás los datos climatologicos como Temperatura, Precipitación, Humedad, Presión. Puedes marcar la casilla "consultar mi ubicación" o arrastrar el marcador para una nueva ubicación.
                        </p>     
          </div>
        </div>
