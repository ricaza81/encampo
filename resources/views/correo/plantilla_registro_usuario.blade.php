...
<div class="" ><h3>idZona: <?=$idZona;?></h3></div>
<div class="" ><h3>idEmpresa: <?=$idEmpresa;?></h3></div>
<div class="" ><h3>idSuscriptor: <?=$idSuscriptor;?></h3></div>
<div class="" ><h3>tipoUsuario: <?=$tipoUsuario;?></h3></div>
