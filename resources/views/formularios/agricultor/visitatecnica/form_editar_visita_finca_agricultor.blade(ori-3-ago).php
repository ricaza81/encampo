...
<form  id="form1_nuevo_producto_visitatecnica_agricultor"  method="post"  action="" class="form-horizontal form_entrada" >
  <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"> 
   ...
   <input type="hidden" class="form-control" id="id_visita" name="id_visita" value="<?= $visita->id; ?>">
...
<div class="col-md-4"> </div>
          ...
          <button type="button" class="btn btn-block btn-primary btn-flat" onclick="window.location.href='{{asset('form_editar_visita_finca_agricultor/'.$id)}}'">Actualizar</button> <br/> <br/>
            </div>    
