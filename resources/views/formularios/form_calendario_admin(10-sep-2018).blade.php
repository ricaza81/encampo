...
<div class="form-group">
  ...
  <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                        ...
                        <div class="form-group">
                          <label for="comercial">Select a user</label>
                         ...
                         <div class="form-group">
                          <label for="prospecto">Select a lead</label>
            ...
            <!--    <button type="submit" id="DELETE" class="btn btn-default"><i class="fa fa-trash-o"></i>Borrar</a></button> -->
             ...
             <!-- THE CALENDAR -->
              ...
              <div class="callout callout-success">
                <h4>To see a event, mousetout with your mouse.</h4>
...
$("#calendar").fullCalendar( 'updateEvent' );
  ...
  $("#calendar").fullCalendar( 'rarenderEvents' );
   ...
   $('#calendar').fullCalendar({
       ...
       events: '/crm_blade/public/events_prospectos_admin/'+event.target.value,
      editable: true,
      header: {
