...
<div class="row docs-premium-template">
  ...
  <h3 class="box-title">Fenología del Cultivo</h3>
                                 <div class="box box-primary col-xs-6">   
...
<input type="hidden" class="form-control" id="idcultivo" name="idcultivo" placeholder="idcultivo" value="">
   ...
   <img src="cultivo/13/fenologia.jpg"  alt="Fenología"  style="width:100%;height:auto;" id="fenologia_cultivo" name="fenologia_cultivo">
