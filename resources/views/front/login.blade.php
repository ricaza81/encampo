  ...
  <body class="mini-sidebar">
    ...
    <div class="col-md-3"></div>
        <div class="col-md-3 text-right"> 
             ...
             <div class="agronielsen" id="agronielsen" style="padding-top:80px;font-size:50px;color:#fff;line-height:45px;float:right">Agronielsen <b>en Campo</b>
                            <div class="box-body">
                                  <div class="white typed" style="padding-top:20px;font-size:35px;color:#fff;line-height:32px;" id="type">                                 
                                  </div>
