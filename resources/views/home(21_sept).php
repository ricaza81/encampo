        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              <a href="#">
                <i class="fa  fa-users"></i> <span>COMERCIALES</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="javascript:void(0);" onclick="cargarformulario(2);" ><i class="fa fa-circle-o"></i>Cargar Datos Us. </a></li>
                        ...
                        <li class="treeview">
              <a href="#">
                <i class="fa fa-fw fa-database"></i> <span>PROSPECTOS</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
              ...
              <?php
                ...
                <li class="active"><a href="javascript:void(0);" onclick="cargarlistado(7,1);" ><i class="fa fa-circle-o"></i>BD Prospectos</a></li>
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-fw fa-calendar"></i> <span>PROGRAMACIÓN</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
             
              <?php
                 if ($usuario->tipoUsuario==1) { ?>
                <li class="active"><a href="javascript:void(0);" onclick="cargarformulario(5);" ><i class="fa fa-circle-o"></i> Asesor</a></li>
                <li class="active"><a href="javascript:void(0);" onclick="cargarformulario(6);" ><i class="fa fa-circle-o"></i> Administrador</a></li>
             <!--   <li class="active"><a href="javascript:void(0);" onclick="cargarlistado(7,1);" ><i class="fa fa-circle-o"></i>BD Prospectos</a></li> -->
               <?php }?>
               <?php
                 if ($usuario->tipoUsuario==2) { ?>
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-fw fa-dashboard"></i> <span>REPORTES</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
