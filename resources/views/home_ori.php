...
<html>
  <head>
   ...
   <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    ...
    <!-- Date Picker -->
    <link rel="stylesheet" href="plugins/datepicker/datepicker3.css"> <!-- Tell the browser to be responsive to screen width -->
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <?php
                ...
                <li class="active"><a href="listado_todos_prospectos_comercial" ><i class="fa fa-circle-o"></i>Leads</a></li>
            ...
            <li class="treeview">
              ...
              <?php
                ...
                <li class="active"><a href="javascript:void(0);" onclick="cargarlistado(8);" ><i class="fa fa-circle-o"></i> My Events List</a></li>
        ...
        <section class="content-header"> 
         ...
         <!-- contenido capas modales -->
          ...
          <?php 
           ...
           if($usuario->tipoUsuario==1){ include('menus/submenu_admin_evento.php'); }   
