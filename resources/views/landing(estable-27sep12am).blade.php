...
<body id="home-version-2" class="home-version-2" data-style="default">
    ...
    <div id="">
        ...
        <div class="container">
            <div class="row" style="margin-top: 126px;">
                <div class="col-lg-6" style="padding-bottom: 8px;">
                    <div class="prosess-feature-image wow fadeInLeft text-left" style="margin-bottom: -237px;">
                        <h4 class="box-title"style="margin-top: -20px;">Geoposición y variables de clima para fincas</h4>
                        <!--<button id="calculate" onClick="calcar()">Calcular Hectareas</button>-->
                         

                       
                        <div id="map" style="height:67%;border-radius: 7px;"></div>
                           <input type="text" id="coords2" name="coords" style="color:#000">
                             <input type="hidden" id="altitud" name="altitud">

                    </div>   
                     <div class="row" style="margin-top:0px;width:100%;margin-bottom: 0px;padding-top: 98px;">
                          
                               <!-- <a href="register" style="margin-top: 0px;
    width: 100%;
    margin-left: 15px;
    margin-right: -18px;
 ...
 <a href="" id="enlace1" style="margin-top: 0px;
    width: 100%;
    margin-left: 15px;
    margin-right: -18px;
    background-color: #22d976;
    ...
    font-size: 24px;border-radius:5px;" target="_blank" class="btn btn-primary" >
                                 ...
                                 <!--<a href="register" class="btn btn-purple btn-lg full-width" data-wow-delay="0.0s" style="background-color: #22d976; font-size: 18px; font-weight: 600;">Crear Finca</a>-->
                ...
                <div class="col-lg-6">
                   <div class="box box-widget widget-user" style="margin-top: -10px;margin-left:0px;text-align: left;">
                    <span style="text-align: left;font-size:12px; font-weight: 500;line-height:25px;color:#000;letter-spacing:0px">Datos en tiempo real
                    </span>
   ...
   <span id="ciudad" style="font-size:22px;float: left; color: #fff;font-weight: 700;"></span><span style="color: #fff;"> ,
    ...
    font-size: 24px;border-radius:5px;" target="_blank" class="btn btn-primary" >
                ...
                <a href="consultaclima" style="margin-top: 0px;width: 100%;
    margin-top: -6px;
    margin-right: 0px;
    background-color: #034290;
    border-color: #034290;
    height: 61px;
    font-size: 22px;letter-spacing:-2px;border-radius:5px;" target="_blank" class="btn btn-primary" >
                                    <span style="font-size:14px">Consultar por</span>
                                    Latitud y Longitud</a>
                                   
                                       
                    

            <!--<a id="enlace" href="" target="_blank">Test</a>-->
...
//$('#enlace').html(textoActivo.link(URL));
</script>-->

        <!--<div class="box-footer responsive-display-none" style="margin-top: 220px;">
            <div class="row">
                <div class="swiper-slide swiper-slide-weather" data-swiper-parallax="-500" style="margin-top: -30px;">
                    <div class="day-wethear-item">
                        <h5 class="description-header"><span id="temp_max"></span> &#8451;</h5>
   ...
   <section id="download" style="padding: 150px 0 13px;">
            <div class="container">
              <div class="row">
                <div class="col-md-7">
                    <div class="banner-content">
                        ...
                        <div class="row" style="margin-right: 9px; margin-left: -15px; float: right;">
                            <div class="col-xs-4">
                                <a href="https://docs.google.com/presentation/d/e/2PACX-1vTt3pYzhZl0SAZMpeI6j6_qcyFFR-Uzua7t7PC6gx5wlRS6jkpKQDn-Hj0REaVgCdgXU2x3VOJCsClP/pub?start=false" target="_blank" class="btn btn-primary" style="background: #000;
    z-index: 99999;">
            ...
            d="M1920.000,58.998 L1920.000,164.998 L0.000,164.998 L0.000,119.999
            ...
            <title>Wave</title>
            <path id="wave-two"
            d="M1093.910,5.685 C1317.402,-23.097 1421.263,80.301 1608.427,83.440
