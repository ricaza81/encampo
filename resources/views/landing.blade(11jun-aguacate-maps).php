...
<head>
 ...
 <div class="box">
  ...
  <div class="endorsed">
                      ...
                      <div id="map"style="width:60%;height:400px;margin:auto;margin-top:50px;float:left">Geoposición de Agricultores, Fincas y Visitas Técnicas en Campo
        </div>
        <div id="pano" style="width:40%;height:400px;margin:auto;margin-top:50px;float:right;">hohkj
        </div>
  </div>
...
{   
   ...
   //   var fenway = {lat: 42.345573, lng: -71.098326};
      ...
      */          var infowindow = new google.maps.InfoWindow({
      content: "Información de la Finca: <b>La Gloria</b><br/>Ubicación: La Virginia<br/>Agricultor: Carlos Satizabal<br/>Asesor tecnico: Ing. Carlos Sanabria<br/>Ver Detalle"
   });
