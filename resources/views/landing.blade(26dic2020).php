...
<body id="home-version-2" class="home-version-2" data-style="default">
    ...
    <section id="prosess1" style="margin-bottom: -95px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-5" style="margin-top: -37px;padding-bottom: 25px;padding-left: 33px;">
                    <div class="" style="">
                        ...
                        <div class="norebro-tabs-sc tab-box tabs-left" data-appxbe-tab-box="true" style="padding-bottom:129px;">
                            <div class="buttons-wrap">
                                <ul class="buttons" role="tablist">
                                    ...
                                    <li class="button">Fincas</li>
                                    <li class="button">Asistencia</li>
                            ...
                            <div class="items" role="tabpanel">
                                <div class="item active" data-title="Concept">
                                    <div class="tab-content">
                                        <p>
                                            La estructura del CRM, permite crear y administrar agricultores, como los usuarios finales de los productos fertilizantes y agroinsumos en general.
                                        </p>
                                        <a href="https://www.agronielsen.com/encampo/public/descargables/CRMAgronielsenV2.pdf" target="_blank" class="read-btn">Brochure PDF<i class="ei ei-arrow_right"></i></a>
                                    </div>
                                </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8" style="margin-top: 0px;margin-left:-39px;margin-right: -92px;">
                 ...
                 <div class="img-one" style="width: 115%;
    margin-left: -19px;
    margin-top: -43px;padding-top:0px;">
                            <img class="responsive" style="width: 96%" src="https://www.agronielsen.com/encampo/public/css/appx/media/meteo/meteoag.jpg" alt="Variables meteorológicas" />
                 </div>

               
           </div>

            <div class="col-md-4" style="padding-left: 152px;">

                 <iframe  style="margin-top: 0px;height: 395px;width:390px;padding: 13px;" id="historyframe" name="historyframe"  src="" frameborder="0" style="border:0" allowfullscreen>
                 </iframe>
     ...
     <section id="prosess1" style="padding-bottom: 25px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-5" style="margin-top: -69px;">
                    <div class="prosess-tabs-inner wow fadeInRight">
                        <h2 class="title" style="padding-top: 31px;">
                            ...
                            <div class="items" role="tabpanel">
                                ...
                                <div class="item" data-title="Design">
                                    <div class="tab-content">
                                        ...
                                        <a href="https://bit.ly/3pbImdq" target="_blank" class="read-btn">Ver variables de fincas<i class="ei ei-arrow_right"></i></a>
                                    </div>
                                </div>
                                <div class="item" data-title="Deployment">
                                    <div class="tab-content">
