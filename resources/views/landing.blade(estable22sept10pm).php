                ...
                <div class="col-lg-6" style="padding-bottom: 8px;">
                    <div class="prosess-feature-image wow fadeInLeft text-left" style="margin-bottom: -237px;">
                        ...
                        <div id="map" style="height:67%;border-radius: 7px;"></div>
                           <input type="hidden" id="coords" name="coords" style="color:#000">
                ...
                <div class="" data-swiper-parallax="-500" style="margin-top:0px;">
                    ...
                    <div class="day-wethear-item">
                        ...
                        <span class="description-text" style="color: #000000;">Probab.Lluvia</span>
                                                                    ...
                                                                    <a href="https://datastudio.google.com/reporting/1eb7e239-e6bf-41bf-b66c-c531e161757d/page/ZghgB" style="margin-top: 0px;
    width: 100%;
    margin-top: 16px;
    margin-right: 0px;
    background-color: #22d976;
