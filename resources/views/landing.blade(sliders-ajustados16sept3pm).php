...
<body id="home-version-2" class="home-version-2" data-style="default">
 ...
 <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel" style="color: #000;">
   <div class="carousel-inner" style="color: #fff;">
      <div class="carousel-item active" style="color: #fff;">
         <!--<div class="ajuste-caption">
            <h1 style="color:#1e2532;text-transform:none" >Mejores datos, mayor rentabilidad
            </h1>
            <h2 style="color:#1e2532">Ciencia de datos aplicada a las ventas reales de agroinsumos.
            </h2>
            <img src="https://www.agronielsen.com/encampo/public/css/appx/media/banner/encampoapp.png" class="wow fadeInRight" alt="Laptop" style="margin-top:-120px">
            </div>-->
         <div class="ajuste-caption">
            <div class="container">
               <div class="row">
                  <div class="col-lg-5">
                     <div class="prosess-tabs-inner" style="text-align: left;margin-top: 0px;">
                        <h1 class="title" style="color: #1e2532; margin-top: 10px; text-transform: none; line-height:28px;padding-bottom:8px">{{trans('messages.caption1slider')}}
                        </h1>
                        <h1 class="title" style="color: #1e2532; margin-top:-50px; text-transform: none; line-height:28px; font-size:30px;">{{trans('messages.caption1slider1_main')}}
                        </h1>
                        <ul style="padding-top:0px" class="responsive-display-none">
                           <li class="responsive-display-none" style="color: #1e2532;">
                              <span>
                              <i aria-hidden="true" class="fas fa-check"></i>
                              </span>
                              <span style="text-align: left;font-size:20px; font-weight: 500;line-height:25px">{{trans('messages.captions1lider1_point1')}}</span>
                           </li>
                           <li class="" style="color: #1e2532;line-height:20px">
                              <span>
                              <i aria-hidden="true" class="fas fa-check"></i>
                              </span>
                              <span style="text-align: left; font-size: 20px; font-weight: 500;line-height:20px">{{trans('messages.captions1lider1_point2')}}</span>
                           </li>
                           <li class="" style="color: #1e2532;">
                              <span class=""> <i aria-hidden="true" class="fas fa-check"></i> </span>
                              <span style="text-align: left; font-size: 20px; font-weight: 500;">{{trans('messages.captions1lider1_point3')}}</span>
                           </li>
                        </ul>
                        <div class="container">
                           <div class="row">
                              <a href="visor" class="btn btn-purple btn-lg full-width" data-wow-delay="0.0s" style="background-color: #22d976; font-size: 18px; font-weight: 600;">{{trans('messages.captions1lider1_boton')}}</a>
                           </div>
                        </div>
                     </div>
                  </div>
                  <!--<div class="feature-image">
                     <a href="register"><img src="https://www.agronielsen.com/encampo/public/css/appx/media/faq/pdto/2.png" class="wow fadeInUp" alt="Mobile"></a>
                     </div>-->
<div class="col-lg-6">
    <div class="box box-widget widget-user">
        <h3 class="box-title" style="color: #fff;">Tu ubicación actual</h3>
        <!-- Add the bg color to the header using any of the bg-* classes -->
        <div class="widget-user-header bg-aqua-active">
            <h3 class="widget-user-username"><span id="ciudad" style="float: left; color: #fff;"></span><br>
                <span style="float: left; color: #fff;">Variables &amp; CLIMA</span></h3>
            
        </div>
        <div class="widget-user-image">
            <img class="" id="icon" src="" alt="Tiempo" style="border: 0px solid #fff"/>
        </div>
        <div class="box-footer" style="margin-bottom: -228px;">
            <div class="row">
                <div class="swiper-slide swiper-slide-weather" data-swiper-parallax="-500">
                    <div class="day-wethear-item">
                        ...
                        <span class="description-text" style="color: #000000;">Temperatura Máxima</span>
                    </div>

                    <div class="day-wethear-item">
                        <h5 class="description-header"><span id="humidity"></span> %</h5>
                        <span class="description-text" style="color: #000000;">Humedad Relativa</span>
                    </div>

                    <div class="day-wethear-item">
                        <h5 class="description-header"><span id="wind"></span> m/s</h5>
                        <span class="description-text" style="color: #000000;">Velocidad viento</span>
                    </div>

                    <div class="day-wethear-item">
                        <h5 class="description-header"><span id="temp_min"></span> &#8451;</h5>
                        <span class="description-text" style="color: #000000;">Temperatura Mínima</span>
                    </div>
                    ...
                    <div class="day-wethear-item">
                        ...
                        <span class="description-text" style="color: #000000;">mm agua(lluvia)</span>
                    </div>
                </div>
            </div>
        </div>
               ...
               <!--<a href="visor">
                  <iframe
                      class="embedly-embed"
                      src="//cdn.embedly.com/widgets/media.html?src=https%3A%2F%2Fdatastudio.google.com%2Fembed%2Freporting%2F0c59c96a-7d93-4f3e-9c05-eeea8e946d39%2Fpage%2FmM3VB%3Ffbclid%3DIwAR2XCOsj8zcLXEAEP5Ruz548A57UknlXK3Eab-DwAk9SCFwjCtbttXwhABc%26params%3D%257B%2522df9%2522%3A%2522include%2525EE%252580%2525800%2525EE%252580%252580IN%2525EE%252580%252580Agronielsen%2522%257D%26feature%3Doembed&dntp=1&display_name=Google+Data+Studio&url=https%3A%2F%2Fdatastudio.google.com%2Freporting%2F0c59c96a-7d93-4f3e-9c05-eeea8e946d39%2Fpage%2FmM3VB%3Ffbclid%3DIwAR2XCOsj8zcLXEAEP5Ruz548A57UknlXK3Eab-DwAk9SCFwjCtbttXwhABc%26params%3D%257B%2522df9%2522%3A%2522include%2525EE%252580%2525800%2525EE%252580%252580IN%2525EE%252580%252580Agronielsen%2522%257D&image=https%3A%2F%2Fdatastudio.google.com%2Freporting%2F0c59c96a-7d93-4f3e-9c05-eeea8e946d39%2Fpage%2FmM3VB%2Fthumbnail%3Fsz%3Dw1200-h900-p-nu%26feature%3Doembed&key=internal&type=text%2Fhtml&schema=google"
                      margin-top="100"
                      width="600"
                      height="400"
                      scrolling="no"
...
<div class="carousel-item">
   <div class="ajuste-caption">
      <div class="container">
         <div class="row">
            <div class="col-lg-5">
               <div class="prosess-tabs-inner" style="text-align: left">
                  <h1 class="title" style="color: #1e2532; margin-top: 0px; text-transform: none; line-height: 44px;">
                     {{trans('messages.caption1slider2')}}<br />
                     {{trans('messages.caption1slider2_main')}}
                  </h1>
                  <!--<h1 style="color:#1e2532;margin-top:-20px">para mejores decisiones.
                     </h1>-->
                  <ul>
                     <li class="" style="color: #1e2532;">
                        <span> <i aria-hidden="true" class="fas fa-check"></i> </span>
                        <span style="text-align: left; font-size: 20px; font-weight: 500;">{{trans('messages.captions1lider2_point1')}}</span>
                     </li>
                     <li class="" style="color: #1e2532;">
                        <span> <i aria-hidden="true" class="fas fa-check"></i> </span>
                        <span style="text-align: left; font-size: 20px; font-weight: 500;">{{trans('messages.captions1lider2_point2')}}</span>
                     </li>
                     <li class="" style="color: #1e2532;">
                        <span class=""> <i aria-hidden="true" class="fas fa-check"></i> </span>
                        <span style="text-align: left; font-size: 20px; font-weight: 500;">{{trans('messages.captions1lider2_point3')}}</span>
                     </li>
                  </ul>
                  <div class="container">
                     <div class="row">
                        <a href="register" class="btn btn-purple btn-lg full-width" data-wow-delay="0.0s" style="background-color: #22d976; font-size: 18px; font-weight: 600;">{{trans('messages.captions1lider2_boton')}}</a>
                     </div>
                  </div>
               </div>
            </div>
            <div class="col-lg-7 responsive-display-none">
               <img src="https://www.agronielsen.com/encampo/public/css/appx/media/banner/agronielsengif.gif" alt="Prosess" style="margin-top: 0px; width: 631px; height: 401px; margin-left: -20px;" />
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-5" style="text-align: left;">
               <div class="prosess-tabs-inner">
                  <h1 class="title" style="color: #1e2532; margin-top: -10px; text-transform: none; line-height: 38px;">
                     {{trans('messages.caption1slider3')}}<br />
                     {{trans('messages.caption1slider3_main')}}
                  </h1>
                  <!--  <h2 style="color:#1e2532">
                     </h2>
                      </h2>-->
                  <ul>
                     <li class="" style="color: #1e2532;">
                        <span> <i aria-hidden="true" class="fas fa-check"></i> </span>
                        <span style="text-align: left; font-size: 20px; font-weight: 500;">{{trans('messages.captions1lider3_point1')}}</span>
                     </li>
                     <li class="" style="color: #1e2532;">
                        <span> <i aria-hidden="true" class="fas fa-check"></i> </span>
                        <span style="text-align: left; font-size: 20px; font-weight: 500;">{{trans('messages.captions1lider3_point2')}}</span>
                     </li>
                     <li class="" style="color: #1e2532;">
                        <span class=""> <i aria-hidden="true" class="fas fa-check"></i> </span>
                        <span style="text-align: left; font-size: 20px; font-weight: 500;">{{trans('messages.captions1lider3_point3')}}</span>
                     </li>
                  </ul>
                  <div class="container">
                     <div class="row">
                        <a href="ventainformes" class="btn btn-purple btn-lg full-width" data-wow-delay="0.0s" style="background-color: #22d976; font-size: 18px; font-weight: 600;">
                        {{trans('messages.captions1lider3_boton')}}
                        </a>
                     </div>
                  </div>
               </div>
            ...
            <div class="col-lg-7 responsive-display-none">
               <!--<iframe
                  class="embedly-embed"
                  src="//cdn.embedly.com/widgets/media.html?src=https%3A%2F%2Fdatastudio.google.com%2Fembed%2Freporting%2F349d2a51-763b-471e-aa2e-9d673e726b60%2Fpage%2FmOlaB%3Ffeature%3Doembed&dntp=1&display_name=Google+Data+Studio&url=https%3A%2F%2Fdatastudio.google.com%2Fembed%2Freporting%2F349d2a51-763b-471e-aa2e-9d673e726b60%2Fpage%2FmOlaB&image=https%3A%2F%2Fdatastudio.google.com%2Fembed%2Freporting%2F349d2a51-763b-471e-aa2e-9d673e726b60%2Fpage%2FmOlaB%2Fthumbnail%3Fsz%3Dw1200-h1300-p-nu%26feature%3Doembed&key=internal&type=text%2Fhtml&schema=google"
                  width="500"
                  height="400"
                  scrolling="yes"
                  title="Investigaciones de mercado del Agro"
                  frameborder="0"
                  allow="autoplay; fullscreen"
                  allowfullscreen="true"
                  ></iframe>-->
               <iframe width="500" height="400" src="https://datastudio.google.com/embed/reporting/349d2a51-763b-471e-aa2e-9d673e726b60/page/mOlaB" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
         </div>
      </div>
   </div>
...
<!--<a class="carousel-control-prev" style="color:#1e2532" href="#carouselExampleCaptions" role="button" data-slide="prev">
...
<!--indicators-->
<!--<div class="container">-->
<div class="page-description text-center" style="border-color: transparent; background: #fff; padding: 20px;margin-bottom: -68px;">
   <ol class="carousel-indicators">
      <li data-target="#carouselExampleCaptions" data-slide-to="0" class="active" style="color: #000; background-color: #000;"></li>
      <li data-target="#carouselExampleCaptions" data-slide-to="1" class="" style="color: #fff; background-color: #000;"></li>
      <li data-target="#carouselExampleCaptions" data-slide-to="2" class="" style="color: #fff; background-color: #000;"></li>
   </ol>
</div>
<!--</div>-->
<!--indicators-->
        ...
        <div class="page-description text-center" style="background: transparent; border-color: transparent; background: #3b5998; padding: 22px;">
            <div class="icon mobile" style="background-color: #7bab33; border: 1px solid #fff; border-radius: 3px;">
                <a href="{{asset('ventainformes')}}">
                    <svg class="olymp-star-icon left-menu-icon" data-toggle="tooltip" data-placement="right" data-original-title="{{ trans('messages.captionslider2_add') }}">
                        <use xlink:href="{{url('/css/olympus/app/svg-icons/sprites/icons.svg#olymp-star-icon')}}"></use>
                    </svg>
                </a>
            </div>

            <a href="{{asset('ventainformes')}}" style="color: #fff;">
                <span
                    style="
                        color: #fff;
                        border: 1px solid #fff; /* padding: 14px; */
                        margin-left: -34px;
                        border-left: 0;
                        font-weight: 600;
                    ...
                    "
                >
                    {{ trans('messages.captionslider2_main') }}
                </span>
                <a href="{{asset('ventainformes')}}" style="color: #fff;"><b>{{ trans('messages.captionslider2_add') }}</b> </a>
                <a href="{{asset('ventainformes')}}" class="icon" style="background-color: #3b5998; border: 1px solid #fff; border-radius: 3px; margin-left: -12px;">
                    <svg class="olymp-star-icon left-menu-icon" data-toggle="tooltip" data-placement="right" data-original-title="Especialidad en cultivo de aguacate">
                        <use xlink:href="{{url('/css/olympus/app/svg-icons/sprites/icons.svg#olymp-newsfeed-icon')}}"></use>
                    </svg>
                </a>
            </a>
        </div>
                        ...
                        <div class="norebro-tabs-sc tab-box tabs-left" data-appxbe-tab-box="true">
                            <div class="buttons-wrap">
                                <ul class="buttons" role="tablist">
                                    ...
                                    <li class="button active undefined">{{ trans('messages.fichaagri') }}</li>
                                    <li class="button">{{ trans('messages.fichaproduct') }}</li>
                                    <li class="button">{{ trans('messages.fichavalor') }}</li>
                                    <li class="button">{{ trans('messages.fichaemails') }}</li>
                                </ul>
                            </div>
                            <div class="items" role="tabpanel">
                                ...
                                <div class="item" data-title="Design">
                                    <div class="tab-content">
                                        <p>
                                            {{ trans('messages.fichaproducttext') }}
                                        </p>
                                ...
                                <div class="item" data-title="Deployment">
                                    <div class="tab-content">
                                        <p>
                                            {{ trans('messages.fichavalortext') }}
                                        </p>

                                        <div style="background: #fff; margin-top: -6px; color: #00a859; border-radius: 4.25rem; font-size: 12px; font-weight: 450; font-family: ; border: 2px solid #00a859; line-height: 0px; padding: 15px;">
                                            Valorización($) = (Dosis/Ha) * (# Ha) * (# Aplicaciones) * (Precio($))
                                        </div>
                                ...
                                <div class="item" data-title="Support">
                                    <div class="tab-content">
                                        <p>
                                            {{ trans('messages.fichatextemails') }}
                                        </p>
                                        <a href="register" class="read-btn">{{ trans('messages.fichaproductbutton') }}<i class="ei ei-arrow_right"></i></a>
                                    </div>
                                </div>
    ...
    <section id="prosess1" style="padding-top: 5px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="prosess-feature-image wow fadeInLeft text-left">
                        <h3 class="box-title">{{ trans('messages.titlegeo') }}</h3>
                        <button id="calculate" onClick="calcar()">Calcular Hectareas</button>
                        <div id="area"></div>
                        <div id="map" style="width: 80%; height: 80%; float: left;"></div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="prosess-tabs-inner wow fadeInRight">
                        <h2 class="title">
                            {{trans('messages.titlegeostmkt')}}
                        </h2>
                        ...
                        <div class="norebro-tabs-sc tab-box tabs-left" data-appxbe-tab-box="true">
                            <div class="buttons-wrap">
                                <ul class="buttons" role="tablist">
                                    <li class="line brand-bg-color"></li>
                                    <li class="button active undefined">{{trans('messages.geocobertura')}}</li>
                                    <li class="button">{{trans('messages.geofotos')}}</li>
                                    <li class="button">{{trans('messages.georendimiento')}}</li>
                                    <li class="button">{{trans('messages.geopotencial')}}</li>
                                </ul>
                            </div>
                            <div class="items" role="tabpanel">
                                <div class="item active" data-title="Concept">
                                    <div class="tab-content">
                                        <p>
                                            {{trans('messages.geocoberturatext')}}
                                        </p>
                                        <a href="producto" class="read-btn">{{trans('messages.geocoberturabutton')}}<i class="ei ei-arrow_right"></i></a>
                                    </div>
                                </div>
                                <div class="item" data-title="Design">
                                    <div class="tab-content">
                                        <p>
                                            {{trans('messages.geofotostext')}}
                                        </p>
                                        <a href="register" class="read-btn">{{trans('messages.fichaproductbutton')}}<i class="ei ei-arrow_right"></i></a>
                                    </div>
                                </div>
                                <div class="item" data-title="Deployment">
                                    <div class="tab-content">
                                        <p>
                                            {{trans('messages.georendimientotext')}}
                                        </p>
                                        <a href="producto" class="read-btn">{{trans('messages.geocoberturabutton')}}<i class="ei ei-arrow_right"></i></a>
                                    </div>
                                </div>
                                <div class="item" data-title="Support">
                                    <div class="tab-content">
                                        <p>
                                            {{trans('messages.geopotencialtext')}}
                                        </p>
                                        <a href="register" class="read-btn">{{trans('messages.fichaproductbutton')}}<i class="ei ei-arrow_right"></i></a>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="banner-content">
                        <h3 class="title wow fadeInUp" data-wow-delay="0.3s">{{trans('messages.seccionuser')}}</h3>

                        <!--   <h2 class="title wow fadeInUp" data-wow-delay="0.3s">y empieza a obtener los beneficios de tus datos</h2>-->

                        <div class="row" style="margin-right: 9px; margin-left: -15px; float: right;">
                            <div class="col-xs-4">
                                <a href="https://docs.google.com/presentation/d/e/2PACX-1vTt3pYzhZl0SAZMpeI6j6_qcyFFR-Uzua7t7PC6gx5wlRS6jkpKQDn-Hj0REaVgCdgXU2x3VOJCsClP/pub?start=false" target="_blank" class="btn btn-primary">
                                    {{trans('messages.seccionuserconsultar')}}
                                </a>
                            </div>
                            <!-- /.col -->
                        </div>
                        ...
                        <div class="login-box card">
                            <div class="card-body">
                                <form action="register" method="post" class="form-horizontal form-material">
                                    ...
                                    <h3 class="box-title text-center" style="padding: 10px 0 10px 0; background: #00a859; color: #fff; border-radius: 4.25rem; font-size: 18px; font-weight: 450; font-family: Montserrat, sans-serif;">
                                        {{trans('messages.seccionuserformtitle')}}
                                    </h3>

                                    <div style="color: #a94442; font-size: 13px; border-color: #ebccd1; line-height: 19px; border-radius: 0.25rem;">
                                        <?php if( isset($errors) ){ ?>
                                        <ul>
                                    ...
                                    <div class="form-group m-t-20">
                                        <label>{{trans('messages.formregistronombre')}}</label>
                                        <input type="text" class="form-control" name="name" required />
                                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                    </div>

                                    <div class="form-group has-feedback">
                                        <label>{{trans('messages.formregistroemail')}}</label>
                                        <input type="email" class="form-control" name="email" required />
                                        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                                    </div>

                                    <div class="form-group has-feedback">
                                        <label>{{trans('messages.formregistropassword')}}</label>
                                        <input type="password" class="form-control" name="password" required />
                                        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                                    </div>

                                    <div class="form-group has-feedback">
                                        <label>{{trans('messages.formregistrocheckpassword')}}</label>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-4">
                                            <button type="submit" class="btn btn-primary">{{trans('messages.formregistrobutton')}}</button>
                                        </div>
                                        <!-- /.col -->
                                    </div>
                                </form>
    ...
    <div class="container">
        <div class="row">
            ...
            <iframe id="blog" src="https://www.agronielsen.com/blog/blog" frameborder="0" width="1240" height="726" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
        </div>
    </div>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD2O6NRzoS7rpQ4ftOgrrzOdPLHUcb1RJk&libraries=geometry,drawing" async defer></script>
    <!-- Dependency Scripts -->
    ...
    <script>
        ...
        function calcar() {
            ...
            (document.getElementById("area").innerHTML = "Area =" + area.toFixed(2) * 0), 0001;
        }
    ...
    <script type="text/javascript">
        document.getElementById("strange2").addEventListener("mouseover", function (event) {
            document.getElementById("popoverContent4").classList.add("keepPopoverOpen");
        });

        document.getElementById("popoverContent4").addEventListener("mouseout", function (event) {
            document.getElementById("popoverContent4").classList.remove("keepPopoverOpen");
        });
    </script>
    <!--informe-->
