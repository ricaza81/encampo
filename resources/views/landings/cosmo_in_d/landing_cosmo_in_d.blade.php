...
<head>
   ...
   <!-- <meta name="viewport" content="width=device-width, initial-scale=1.0"> -->
    ...
    <meta name="twitter:site" content="@cosmoagrotriada" />
    <meta name="twitter:creator" content="@cosmoagrotriada" />

    <title> COSMO-IN d | Mejor dispersión y acción para un mejor control</title>
 ...
 <!-- Fixed navbar -->
    ...
    <div id="headerwrap">
        <div class="container">
            <div class="row centered" >
                <label style="color:#fff;"><b>COSMO-IN d, Coadyuvante no-iónico que mejora las condiciones físicas de las mezclas. </b> <button type="button" class="btn btn-success" onClick="window.location.href='#showcase'">Solicitar Asistencia</button></label>
  ...
  <section id="columna_bg_cosmo_r" name="columna_bg_cosmo_r">
    <div id="beneficios">
        <div class="container">
            <div class="row">
                <h1 class="centered"><b>COSMO-IN d, Mejora la dispersión y acción para un mejor control.</b></h1>
                <br>
                <br>
                <div class="col-lg-6 ">
                <div class="vid">
                    <iframe  widht="560" height="315"  src="https://www.youtube.com/embed/-oCxBBbKdXA?rel=0&autoplay=1" frameborder="0" allowfullscreen ></iframe>
                </div>
            </div>
                    ...
                    <div class="accordion ac" id="accordion2">
                        <div class="accordion-group">
                            ...
                            <div id="collapseOne" class="accordion-body collapse in">
                                ...
                                <h3>Solubiliza más el ingrediente activo en el tanque de mezcla, mejorando la uniformidad de la aplicación del agroquímico, resultando en un mejor control.</h3>
                                </div><!-- /accordion-inner -->
                            </div><!-- /collapse -->
                        </div><!-- /accordion-group -->
                        <br>
                        ...
                        <div class="accordion-group">
                            ...
                            <div id="collapseTwo" class="accordion-body collapse">
                                <div class="accordion-inner">
                                <h3>Dispersa fácilmente los polvos mojables (WP,WS, WG, WT, EG, SP, SG, ST) o productos sólidos en el tanque de mezcla.</h3>
                                </div><!-- /accordion-inner -->
                            </div><!-- /collapse -->
                        </div><!-- /accordion-group -->
                        <br>
                         ...
                         <div class="accordion-group">
                            ...
                            <div id="collapseThree" class="accordion-body collapse">
                                <div class="accordion-inner">
                                <h3>Reduce las posibilidades de altas concentraciones en un sector del tanque (Que generan fitotoxicidades) o diluciones excesivas del ingrediente activo, que generan bajo o ningún control.</h3>
                                </div><!-- /accordion-inner -->
                            </div><!-- /collapse -->
                        </div><!-- /accordion-group -->
                        <br>
                         ...
                         <div class="accordion-group">
                            ...
                            <div id="collapseFour" class="accordion-body collapse">
                                <div class="accordion-inner">
                                <h3>DE FÁCIL MEZCLA con abonos NPK.</h3>
                                </div><!-- /accordion-inner -->
                            </div><!-- /collapse -->
                        </div><!-- /accordion-group -->
                        <br>            
    ...
    <div id="showcase">
        <div class="container">
            <div class="row">
                ...
                <h1 class="centered"><b>Maximice su inver$ión en agroquímicos y fertilizantes y el control esperado y calidad de sus aplicaciones.</b></h1>
                <br>
                <br>
  ...
  <br/>
                  <img  src="{{ asset('/imagenes/cosmo-in-d.png') }}" alt="" style="height: auto;  max-height: 390px;">
            </div>
...
<br/>
            <form id="agregar_lead_landing" method="post"  action="{{ url('/agregar_lead_landing_cosmo_in_d') }}" clas="">
