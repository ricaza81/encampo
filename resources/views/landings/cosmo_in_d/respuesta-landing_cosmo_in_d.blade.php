...
<!-- Fixed navbar -->
 <!-- Fixed navbar -->
    ...
    <div id="showcase">
        <div class="container">
            <div class="row">
                <h1 class="centered"><b>"Con COSMO-R incremente su calidad y volumen de cosecha"</b></h1>
                <br>
                <br>
                <div class="col-lg-6 ">
                <div class="vid">
                      <iframe  widht="560" height="315"  src="https://www.youtube.com/embed/5ExmNYNorqo?rel=0&autoplay=1" frameborder="0" allowfullscreen ></iframe>
                </div>
            </div>
                        ...
                        <div class="accordion-group">
                            ...
                            <div id="collapseOne" class="accordion-body collapse in">
                                ...
                                <p>A continuación lo invitamos a descargar nuestro documento técnico, donde compartimos los resultados obtenidos
                                   de la aplicación de COSMO-R en el cultivo de arroz, logrando un incremento en productividad de más del 11%.
...
<button type="submit" class="btn btn-block btn-success btn-lg" onClick="window.open('http://www.cosmoagro.co/storage/descargables/BOLETIN_TECNICO_EN_BOLIVIA.pdf')" >Descargar Documento</button>
