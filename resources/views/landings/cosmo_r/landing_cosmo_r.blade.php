...
<!-- End Facebook Pixel Code -->
   ...
   <!-- <meta name="viewport" content="width=device-width, initial-scale=1.0"> -->
    ...
    <title> COSMO-R | El Mejor Complemento del NPK</title>
...
fbq('init', '986152801517618'); // Insert your pixel ID here.
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=986152801517618&ev=PageView&noscript=1"
/></noscript>
<!-- DO NOT MODIFY -->
<!-- End Facebook Pixel Code -->
 ...
 <!-- Fixed navbar -->
    ...
    <div id="headerwrap">
        <div class="container">
            <div class="row centered" >
                <label style="color:#fff;"><b>COSMO-R, aumenta la productividad de sus cultivos</b> <button type="button" class="btn btn-success" onClick="window.location.href='#showcase'">Solicitar Asistencia</button></label>
  ...
  <section id="columna_bg_cosmo_r" name="columna_bg_cosmo_r">
    <div id="beneficios">
        <div class="container">
            <div class="row">
                <h1 class="centered"><b>"COSMO-R, El mejor complemento de los NPK"</b></h1>
                <br>
                <br>
                <div class="col-lg-6 ">
                <div class="vid">
                    <iframe  widht="560" height="315"  src="https://www.youtube.com/embed/ZyGLy0zGsd4?rel=0&autoplay=1" frameborder="0" allowfullscreen ></iframe>
                </div>
            </div>
                    ...
                    <div class="accordion ac" id="accordion2">
                        <div class="accordion-group">
                            ...
                            <div id="collapseOne" class="accordion-body collapse in">
                                ...
                                <h3>Aporte BALANCEADO de elementos secundarios y menores 100% quelatados con EDTA.</h3>
                                </div><!-- /accordion-inner -->
                            </div><!-- /collapse -->
                        </div><!-- /accordion-group -->
                        <br>
                        ...
                        <div class="accordion-group">
                            ...
                            <div id="collapseTwo" class="accordion-body collapse">
                                <div class="accordion-inner">
                                <h3>MENOS FIJACIÓN DEL NUTRIENTE en el suelo.</h3>
                                </div><!-- /accordion-inner -->
                            </div><!-- /collapse -->
                        </div><!-- /accordion-group -->
                        <br>
                         ...
                         <div class="accordion-group">
                            ...
                            <div id="collapseThree" class="accordion-body collapse">
                                <div class="accordion-inner">
                                <h3>Cada gránulo CONTIENE LA MISMA PROPORCIÓN DE NUTRIENTES (Mezcla Química).</h3>
                                </div><!-- /accordion-inner -->
                            </div><!-- /collapse -->
                        </div><!-- /accordion-group -->
                        <br>
...
<div class="vid">
  <br/>
                    <iframe  widht="560" height="315"  src="https://www.youtube.com/embed/5ExmNYNorqo?rel=0" frameborder="0" allowfullscreen ></iframe>
            </div></div>
