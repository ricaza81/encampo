        ...
        <div class="row">
          <div class="col-md-7">
            <div class="banner-content">
              <h2 class="title wow fadeInUp">    <?php
 if ($msj==!"") { ?>
          <?php  echo $msj;',' ?> 
<?php } ?></h2>
              <h3 class="title wow fadeInUp" data-wow-delay="0.3s">Gracias por contáctarnos</h3>

              <p class="sub-title wow fadeInUp" data-wow-delay="0.5s">
                Pronto uno de los expertos de los principales fabricantes en Colombia, responderá a tu solicitud.
              </p>

              <a href="#ellos-lo-hicieron" class="banner-btn wow fadeInUp" data-wow-delay="0.7s">Ellos también lo hicieron</a>
            </div>
            <!-- /.banner-content -->
          </div>
          <!-- /.col-md-6 -->
            ...
            <div class="col-lg-3 col-md-7">
              <div class="widget widget-menu">
                ...
                <ul class="footer-menu">
                  ...
                  <li><a href="https://www.agronielsen.com/abre-tu-cuenta-gratis/" target="_blank">Demo de tablero de Análisis</a></li>
                  <li><a href="https://www.agronielsen.com/mineria" target="_blank">Míneria de Clientes</a></li>
                  <li><a href="https://www.agronielsen.com/contacto/" target="_blank">Contacto</a></li>
