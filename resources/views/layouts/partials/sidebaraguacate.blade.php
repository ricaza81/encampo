...
<div class="" style="min-height:0px !important;">
    <div class="">
      <header class="main-header">
        <!-- Logo -->
        <a href="{{asset('form_nueva_finca_aguacate')}}" class="logo">
          <!-- mini logo for sidebar mini 50x50 pixels -->
          <span class="logo-mini"><b>AGRN</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><img src="https://www.agronielsen.com/encampo/public/imagenes/agragcte.png" style="height: auto; width: auto; max-width: 242px; max-height: 44px;"></span>
        </a>
      ...
      <!-- Left side column. contains the logo and sidebar -->
        ...
        <!--  <form action="#" method="get" class="sidebar-form">
          ...
          <ul class="sidebar-menu">
            <li class="header">MODULO AGUACATE</li>
           ...
           <li class="treeview">
              ...
              <?php
                 if ($usuario->tipoUsuario==1 ) { ?>
                <li><a href="{{asset('form_nueva_finca_aguacate')}}"><i class="fa fa-circle-o"></i> Añadir </a></li>
                <li><a href="{{asset('reportfincasaguacate')}}" ><i class="fa fa-circle-o"></i>Fincas Creadas</a></li>

                <li><a href="{{asset('mapagctfincas')}}" ><i class="fa fa-circle-o"></i>Geoposición</a></li>
                <li><a href="{{asset('modmediaagcat')}}" ><i class="fa fa-circle-o"></i>Fotos</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <?php
                 if ($usuario->tipoUsuario==1 ) { ?>
                <li class="active"><a href="{{asset('form_nueva_visita_finca_aguacate')}}"><i class="fa fa-circle-o text-red"></i> Crear Visita </a></li>
               <?php }?>
                <?php
                 if ($usuario->tipoUsuario==1 ) { ?>
                <li class="active"><a href="{{asset('reportvisitasfincasaguacate')}}"><i class="fa fa-circle-o"></i> Reporte </a></li>
     ...
     <li class="treeview">
              ...
              <ul class="treeview-menu">
                 ...
                 <li class="active"><a href="{{asset('modmediaagcat')}}" ><i class="fa fa-circle-o"></i> Banco de Fotos </a></li>
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-fw fa-dashboard"></i> <span>ESTADÍSTICAS</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
  
                 <li class="active"><a href="{{asset('listado_graficas')}}" ><i class="fa fa-circle-o"></i> Ver gráficos </a></li>
              ...
              <ul class="treeview-menu">
                 ...
                 <li class="active"><a href="{{asset('censodane')}}" ><i class="fa fa-circle-o"></i> Visor </a></li>
               ...
               <li class="treeview bg-green">
              <a href="{{asset('form_nuevo_prospecto')}}">
                <i class="fa fa-fw fa-dashboard"></i> <span>MÓDULO GENERAL</span>  <span class="pull-right-container">
                  <small class="label pull-right bg-yellow">nuevo</small>
                </span>
              </a>
