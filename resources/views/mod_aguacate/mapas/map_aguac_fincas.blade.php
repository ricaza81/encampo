...
<div class="callout callout-info"><h3 class="box-title">Geoposicion fincas aguacate  <img src="https://image.flaticon.com/icons/png/512/1038/1038575.png" style="float:right;width:10%;padding-bottom: 30px;"></h3>

  
		<div id="map" style="width: 100%; height: 500px" data-url="{{url('ubicacion_fincas_aguacate')}}" data-token="{{csrf_token()}}"></div>
    ...
    background-color: #4267b2 !important;
        ...
        <div class="col-md-4">
            <div class="callout callout-info"><h3 class="box-title">Reporte:</h3>
             ...
             <div class="info-box">
              <a href="{{asset('reportfincasaguacate')}}"  class="nbtn-two" style="color:#ffffff">Ver Detalle de Fincas</a>
            </div>
