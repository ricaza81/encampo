...
<body id="home-version-2" class="home-version-2" data-style="default">
  ...
  <div id="">
    ...
    margin: 0 0 10px;">
                ...
                <li>
                  <a href="{{asset('landing#asi-funciona')}}">{{ trans('messages.asifunciona') }}
                  </a>
                </li>
    ...
    <section id="banner-two">
     ...
     <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel" style="color:#fff">
                    <ol class="carousel-indicators">
                      <li data-target="#carouselExampleCaptions" data-slide-to="0" class="active" style="color:#fff"></li>
                      <li data-target="#carouselExampleCaptions" data-slide-to="1" class="" style="color:#fff"></li>
                      <li data-target="#carouselExampleCaptions" data-slide-to="2" class="" style="color:#fff"></li>
                    </ol>
                      <div class="carousel-inner" style="color:#fff">
                         
                         <div class="carousel-item active" style="color:#fff">
                           <div class="ajuste-caption">
                                  <h1 style="color:#fff" >Transformamos tu negocio,
                                  </h1>
                                  <p style="color:#fff">de agroinsumos, y aumentamos tus ventas.
                                  </p>
                                 <img src="https://www.agronielsen.com/encampo/public/css/appx/media/banner/encampoapp.png" class="wow fadeInRight" alt="Laptop" style="margin-top:-130px">
                            </div>
                         </div>               
                                  ...
                                  <div class="col-lg-5">
                                    <div class="prosess-tabs-inner wow fadeInRight">
                                                                        <h1 class="title">
                                                                         ...
                                                                         <h2 style="color:#fff">para mejores decisiones.
                                                                         </h2>  
                                    </div>
                                   
                                    <div class="col-lg-7">
                                                  <img src="https://mk0funnelyticse6q9if.kinstacdn.com/wp-content/uploads/2019/06/Final-Funnelytics-Illustration.svg" alt="Prosess">
                                    </div>
                                </div>
                  </div>
              ...
              <div class="icon mobile" style="background-color:#7bab33;border: 1px solid #fff;    border-radius: 3px;">
               ...
               <a href="{{asset('ventainformes')}}" style="color:#fff">
                   <span style="color: #fff;border: 1px solid #fff;/* padding: 14px; */margin-left: -34px;border-left: 0;font-weight: 600; background: linear-gradient(to right,#ff9432,#79a42e);padding-top: 15px;padding-bottom: 16px;padding-left: 8px;padding-right: 22px;    border-radius: 3px;">{{ trans('messages.captionslider2_main') }}
                    ...
                    <a href="{{asset('ventainformes')}}" style="color:#fff"><b>{{ trans('messages.captionslider2_add') }}</b>
                </a></span>
