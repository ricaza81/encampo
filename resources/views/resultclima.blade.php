    ...
    <body id="body">
        <div class="container">
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col col-xl-7 order-xl-2 col-lg-6 order-lg-2 col-md-12 order-md-1 col-sm-12 col-12" style="margin-top: 0px;">
                    <div class="" style="margin-top: 0px; line-height: 16px; padding: 20px; background: #eee; border: 0px solid #155724; border-radius: 0px;">
                    ...
                    <div class="ui-block">
                        <div class="ui-block-content text-center">
                          <a href="<?=$url?>" class="btn btn-purple btn-lg full-width" style="margin-top:3px"target="_blank">Ver reporte
                          </a>
                    ...
                    <div class="" style="margin-top: 0px; line-height: 16px; padding: 20px; background: #eee; border: 1px solid #155724; border-radius: 3px;">
                        <h2 class="presentation-margin text-left" style="letter-spacing: -1px; margin: -12px 0 10px;">Quieres recibir copia del informe?
                        </h2>
                        <span style="font-size: 18px; line-height: 11px; color: #155724;margin-bottom: 10px">
                            
                        </span>
                        <div id="notificacion_resul_fci" class="hidden"><?=$msj?></div>
                          
                          <form id="" class="" action="{{ url('/notificationclima') }}" method="post">
                            <!--<form id="copy_report_climate" class="formarchivo" action="envio_reporte_climacoords" method="post">-->
                            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                            <input type="hidden" name="id_consulta" id="id_consulta" value="<?= $id_consulta; ?>"> 
                              <div id="email_report" class="form-group label-floating is-empty">
                                <label class="control-label"></label>
                                <input class="form-control" style="background:#fff/*padding: 1.3rem 1.1rem 1.3rem;*/" type="email" placeholder="Ingresa tu email" id="email_report" name="email_report" required>
                              </div>
                              <button id="" style="font-size:25px;margin-top: 0px;" class="btn btn-purple btn-lg full-width" type="submit">Recibir informe
                              </button>
                            </form>
           ...
           <div class="col col-xl-5 order-xl-2 col-lg-6 order-lg-2 col-md-12 order-md-1 col-sm-12 col-12">
