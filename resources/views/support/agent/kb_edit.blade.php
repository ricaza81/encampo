    ...
    <div class="chat">
      <div class="chat-header clearfix">
        ...
        <div class="chat-about">
          <div class="chat-with">{{ $kbs[0]['title'] }} <span class="label label-success">Knowledgebase</span></div>
        </div>
      ...
      @if (count($errors) > 0)
          ...
          @endif
           <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/knowledgebase/update') }}">
...
<input type="hidden" name="id" value="{{ $kb->id }}">
  <div class="form-group">
              ...
              <div class="col-md-6">
              <input type="text" class="form-control" name="title" value="{{ $kb->title }}" required>
              </div>
            </div>
              <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <textarea class="form-control" name="desc" rows="10" required>
                  {{ $kb->description }}
                </textarea>
              </div>
            </div>
