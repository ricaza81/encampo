    ...
    <div class="chat">
      <div class="chat-header clearfix">
        ...
        <div class="chat-about">
          <div class="chat-with">{{ $kbs[0]['title'] }} <span class="label label-success">Knowledgebase Article</span></div>
        </div>
...
<div class="alert alert-success">
<h1>{{ $kb->title }} </h1>
<p class="small"><strong>Published on</strong> {{ $kb->date }} &nbsp; &nbsp;<strong>Tag:</strong> <span class="label label-success">{{ $kb->product->product }} </span></p>
</div>
<br />
