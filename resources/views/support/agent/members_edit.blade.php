    ...
    <div class="chat">
      <div class="chat-header clearfix">
        ...
        <div class="chat-about">
          <div class="chat-with">{{ $members[0]['member'] }} <span class="label label-success">Customers</span></div>
        </div>
      ...
      @if (count($errors) > 0)
          ...
          @endif
           <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/members/update') }}">
