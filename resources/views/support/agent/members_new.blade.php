    ...
    <div class="chat">
      <div class="chat-header clearfix">
        ...
        <div class="chat-about">
          <div class="chat-with">New Customer <span class="label label-success">Customers</span></div>
        </div>
      ...
      @if (count($errors) > 0)
          ...
          @endif
           <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/members/save') }}">
<input type="hidden" name="_token" value="{{ csrf_token() }}">
  ...
  <div class="form-group">
             ...
             <div class="form-group">
              ...
              <div class="col-md-6">
              <input type="password" autocomplete="off" class="form-control" name="pass" value="" required>
              </div>
            </div>
  <div class="form-group">
