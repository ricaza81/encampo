    ...
    <div class="chat">
      <div class="chat-header clearfix">
        ...
        <div class="chat-about">
          <div class="chat-with">{{ $products[0]['product'] }} <span class="label label-success">Products</span></div>
        </div>
      ...
      @if (count($errors) > 0)
          ...
          @endif
           <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/products/update') }}">
...
<input type="hidden" name="id" value="{{ $product->id }}">
  <div class="form-group">
              ...
              <div class="col-md-6">
              <input type="text" class="form-control" name="name" value="{{ $product->product }}" required>
              </div>
            </div>
             <div class="form-group">
              <label class="col-md-4 control-label">Product Page URL*</label>
              <div class="col-md-6">
              <input type="text" class="form-control" name="url" value="{{ $product->url }}" required>
              </div>
            </div>
