    ...
    <div class="chat">
      <div class="chat-header clearfix">
        ...
        <div class="chat-about">
          <div class="chat-with">Products &nbsp; &nbsp; &nbsp; <a class="btn btn-success btn-xs"  title="New Ticket" href="{{ URL::to('admin/products/create') }}"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> New Product</a></div>
        </div>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $product->url }}</td>
              <td>
                <a class="btn btn-warning btn-xs"  title="Edit" href="{{ URL::to('admin/products/edit/' . $product->id) }}"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                <!-- <a class="btn btn-danger btn-xs"  title="Delete" href="{{ URL::to('admin/products/delete/' . $product->id) }}"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a> -->
              </td>
            </tr>
            @endforeach
            {!! str_replace('/?', '?', $products->appends(Input::except('page'))->render()) !!}
                   @else
