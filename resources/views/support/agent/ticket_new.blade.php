    ...
    <div class="chat">
      <div class="chat-header clearfix">
        ...
        <div class="chat-about">
          <div class="chat-with">New Ticket <span class="label label-success">Tickets </label></div>
        </div>
      ...
      @if (count($errors) > 0)
          ...
          @endif
           <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/ticket/save') }}">
<input type="hidden" name="_token" value="{{ csrf_token() }}">
  ...
  <div class="form-group">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <label class="col-md-4 control-label">Envato Purchase Key</label>
              <div class="col-md-6">
              <input type="text" class="form-control" name="envato_key" value="" >
               <span id="helpBlock" class="help-block">for verification </span>
              </div>
            </div>
