    ...
    <div class="chat">
      <div class="chat-header clearfix">
        ...
        <div class="chat-about">
          <div class="chat-with"><span class="text-capitalize"></span> Tickets &nbsp; &nbsp; &nbsp; <a class="btn btn-success btn-xs"  title="Nuevo ticket" href="{{ URL::to('ticket_new') }}"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Solicitar Soporte</a></div>
        </div>
        ...
        @if (count($errors) > 0)
          ...
          <tbody>
            ...
            {!! str_replace('/?', '?', $tickets->appends(Input::except('page'))->render()) !!}
                    ...
                    <br />
                       <h3 class="text-center">No Tickets Found!</h3>
                    @endif
