        ...
        <div class="row">
          <div class="col-md-7">
            <div class="banner-content">
              <h2 class="title wow fadeInUp mobile"></h2>
              ...
              <p class="sub-title wow fadeInUp" data-wow-delay="0.5s">
                Con Agronielsen en campo, obtienes mejores rutas de tus visitas técnicas,<br>mayor seguimiento de las visitas de seguimientos posteriores,<br>mayor efectividad de tus campañas de mercadeo.
              </p>
      ...
      <div class="container">
        <div class="row">
            ...
            <div class="prosess-feature-image wow fadeInLeft text-right">
              ...
              <div class="img-two fadeInDown">
                <img src="https://www.agronielsen.com/encampo/public/css/appx/media/faq/pdto/reporte-cron-vt-asesor.png" alt="Prosess">
              </div>
...
.form-group {
    ...
    padding: 22px;">
							<div class="icon mobile" style="background-color:#7bab33;border: 1px solid #fff;    border-radius: 3px;">
								<svg class="olymp-star-icon left-menu-icon" data-toggle="tooltip" data-placement="right" data-original-title="Estos son los mejores Asesores Técnicos"><use xlink:href="{{url('/css/olympus/app/svg-icons/sprites/icons.svg#olymp-star-icon')}}"></use></svg>
							</div>
   ...
   background: linear-gradient(to right,#ff9432,#79a42e);
    ...
    padding-bottom: 16px;
    padding-left: 8px;
    padding-right: 22px;    border-radius: 3px;">Estos son los mejores
    <a href="rankingasesores" style="color:#fff"><b>Asesores Técnicos</b></a></span>
		<a href="rankingasesores" class="icon" style="background-color:#3b5998;border: 1px solid #fff;    border-radius: 3px;margin-left:-12px">
								<svg class="olymp-star-icon left-menu-icon" data-toggle="tooltip" data-placement="right" data-original-title="Estos son los mejores Asesores Técnicos"><use xlink:href="{{url('/css/olympus/app/svg-icons/sprites/icons.svg#olymp-newsfeed-icon')}}"></use></svg>
							</a>				
 ...
 <section id="swape">
      <div class="container">
       <div class="section-title title-two" style="    position: relative;
    overflow: hidden;background-color: #fafbff">
          <h2>Visor de Oportunidades (DEMO)</h2>
        </div>
    ...
    overflow: hidden;background-color: #fafbff">
          <div class="col-lg-4 col-md-6">
            <div class="feature-box-two box-three b-br sm-brn text-center wow fadeIn" data-wow-delay="0.3s">
              ...
              <div class="content">
                <h3>Todas las métricas</h3>
                <p>
                  Por medio del Visor de Oportunidades, se obtienen todas las métricas de gestión de forma automática.
                </p>
              </div>
            </div>
            <!-- /.feature-box-two -->
          ...
          <div class="col-lg-4 col-md-6">
            <div class="feature-box-two box-three b-br br-n sm-brn text-center wow fadeIn" data-wow-delay="0.5s">
              ...
              <div class="content">
                <h3>Estimación del Potencial Biológico</h3>
                <p>
                  Estime su potencial biológico en función de su cobertura comparado con el Censo Nacional Agropecuario oficial del DANE.
                </p>
              </div>
            </div>
            <!-- /.feature-box-two -->
          ...
          <div class="col-lg-4 col-md-6">
            <div class="feature-box-two box-three b-br b-r bdr-none text-center wow fadeIn" data-wow-delay="0.7s">
              ...
              <div class="content">
                <h3>Análisis por Agricultor</h3>
                <p>
                  Identificará rápidamente cuales son sus agricultores más importantes clasificados de acuerdo a su
                  potencial de venta.
                </p>
              </div>
            </div>
            ...
            <!--<iframe src="https://agronielsen.clicdata.com/v/7Qrwf4sfjUwE?testempresa=8" width="1050" height="1800" border="0"></iframe>-->
<div class="page-description text-center" style="background:transparent;border-color: transparent;background:#434343;padding:22px;padding-top:100px">            
